...
while True:
    ...
    #camera_matrix = np.array(
    #        [[1.47561396e+03, 0.00000000e+00, 9.39980693e+02],
    #        [0.00000000e+00, 1.46797152e+03, 4.42027992e+02],
    #        [0.00000000e+00, 0.00000000e+00, 1.00000000e+00]], dtype="float32"
    #)
    ...
    for d in image:
        ...
        try:
            bottomLeftCorners, topLeftCorners, topRightCorners, bottomRightCorners  = [item for item in d.location]
        except:
            continue
        ...
        try:
            ...
            (success, rotation_vector, translation_vector) = cv2.solvePnP(model_points, image_points, camera_matrix, dist_coeffs, cv2.SOLVEPNP_IPPE_SQUARE)
            print("\n",rotation_vector)
        ...
        if  rotation_vector[0] < 0 and -0.25 < rotation_vector[2] < 0.25 and 15 < (angles[0]) < 20:  
            yaw_values.append(angles[1])
            dist_values.append(translacion.item(2))
            #pitch_values.append(angles[0])
            print("\nRotation Pitch: ",angles[0])
