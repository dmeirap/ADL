...
while True:
    ...
    if not ret:
        continue
    size = im.shape #Tamaño de la imagen [0]x[1] = [width]x[height]
    ...
    for d in decode(im):
        ...
        #im = cv2.putText(im, s, (d.rect.left, d.rect.top + d.rect.height+50),cv2.FONT_HERSHEY_SIMPLEX, 1.5, (0, 0, 255), 2, cv2.LINE_AA)
